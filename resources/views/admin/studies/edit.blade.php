...
@section('content')
    <div class="col-md-6">
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                <form action="{{ route('studies.update', $study) }}" method="POST">
                    @csrf
                    @method('put')
                    <div class="row">
                        <div class="col-12 mb-3">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="name"
                                name="name" value="{{ old('name', $study->name) }}" placeholder="Study name">
                            @error('name')
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <select name="departement_id" id="departement_id"
                                ...
                                @foreach ($departements as $departement)
                                    <option value="{{ $departement->id }}" @selected($departement->id == old('departement_id') || $departement->id == $study->departement_id)>
