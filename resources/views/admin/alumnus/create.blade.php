                    ...
                    <div class="row">
                        <div class="col-12 mb-3">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="name"
                                name="name" value="{{ old('name') }}" placeholder="Alumnus name">
                            @error('name')
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <input type="text" class="form-control @error('nim') is-invalid @enderror" id="nim"
                                name="nim" value="{{ old('nim') }}" placeholder="Alumnus NIM">
                            @error('nim')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <input type="text" class="form-control @error('gpa') is-invalid @enderror" id="gpa"
                                name="gpa" value="{{ old('gpa') }}" placeholder="Alumnus GPA" maxlength="4">
                            @error('gpa')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <input type="text" class="form-control @error('title_of_final_task') is-invalid @enderror"
                                id="title_of_final_task" name="title_of_final_task" value="{{ old('title_of_final_task') }}"
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <input type="text" class="form-control @error('email') is-invalid @enderror" id="email"
                                name="email" value="{{ old('email') }}" placeholder="Alumnus email">
                            @error('email')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
